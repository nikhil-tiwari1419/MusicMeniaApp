...
function RecentlyPlayed() {
  ...
  const SongCard = ({ song, index }) => (
    <div
      ...
      className={`group flex items-center justify-between p-3 rounded-2xl transition-all duration-300 cursor-pointer border
      ${
        dark
  ...
  return (
    <div
      className={`w-full rounded-3xl p-5 shadow-lg border transition-all duration-300
      ${
        dark
